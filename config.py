...
# Chunker settings chosen for the short, paragraph-based campus_life posts.

CHUNK_SIZE = 400        # target maximum, with paragraph and sentence boundaries
CHUNK_OVERLAP = 0       # paragraphs stay intact; each piece repeats its heading


# ─── Retrieval (Milestone 4) ─────────────────────────────────────────────────

TOP_K = 2               # top two were useful; later results added neighboring topics
...
#
# Measured on five in-corpus and five out-of-corpus questions. The in-corpus
# best distances topped out at 0.246; the nearest out-of-corpus result was 0.825.
THRESHOLD = 0.55
